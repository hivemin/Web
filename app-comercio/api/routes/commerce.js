...
const { validatorGetItem, validatorCreateItem, validatorDeleteItem, validatorUpdateItem } = require("../validators/commerce");
...
router.put("/", authMiddleware, checkRol(['commerce']), validatorUpdateItem, updateItem);
